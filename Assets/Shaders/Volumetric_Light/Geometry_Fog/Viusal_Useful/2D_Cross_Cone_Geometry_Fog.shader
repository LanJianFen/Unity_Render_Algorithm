    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 fragmentShader(v2f i) : SV_Target
            {
                ...
                // ============
                float3 camera_os = TransformWorldToObject(_WorldSpaceCameraPos);
                float3 view_dir = normalize(camera_os - i.position_os);
                float NdotV = dot(i.normal_os, view_dir);
                ...
                // 最终融合！  
                half3 finalColor = depth_blend_falloff  * NdotV2 * horizontal_falloff * vertical_falloff * _Intensity * _FogColor.rgb;
